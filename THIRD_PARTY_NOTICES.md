...
Dependency versions are pinned by `package-lock.json`. Preserve upstream notices when redistributing.

- Tesseract.js, Tesseract core and English trained data: Apache-2.0. https://github.com/naptha/tesseract.js · https://github.com/tesseract-ocr/tessdata
